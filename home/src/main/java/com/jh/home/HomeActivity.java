...
//    TextView textView2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       OtherService otherService = (OtherService) MyRouter.getInstance().buildProvider("/other/provider").navigation(OtherService.class,this);
       otherService.text("11111");
        textView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MyRouter.getInstance().build("/other/text1").navigation(HomeActivity.this);
            }
        });
